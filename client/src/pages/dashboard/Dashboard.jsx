    ...
    <>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="inline-block text-2xl font-bold">{data?.emergencyCampaignResult}</span>
                  <span className="inline-block text-xl text-gray-500 font-semibold">(1%)</span>
                  <span className="block text-gray-500">Emergency Campaigns This Month</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">The number of fund raised per month</div>
              ...
              <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Campaings</div>
                <div className="p-4 flex-grow">
