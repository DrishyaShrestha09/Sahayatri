...
const Home = () => {
  return (
    <div className="container">
      <div className="imgCont flex align-middle mx-10">
        <img
          src={childrens}
          alt="Small childrens smiling"
          className="w-360 h-170 rounded-[80px] p-5"
        />
      </div>
      <div className="textCont flex mt-10 mx-20 space-x-3">
        <h1 className="text-3xl font-bold">Sahayatri - Together, We </h1>
        <p className="text-3xl font-bold text-[#008080]">Make Dreams Happen!</p>
      </div>
