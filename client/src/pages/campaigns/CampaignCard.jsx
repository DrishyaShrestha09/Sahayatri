      ...
      <div className="cardCampaign flex w-[30%] m-4">
        <div className="rounded-2xl overflow-hidden shadow-xl bg-white">
          ...
          <div className="p-6 text-lg">
            <Link to={`/campaigns/${campaign?._id}`}>
              {" "}
              <h3 className="font-semi-bold text-xl mb-4 text-gray-900 hover:text-blue-600">
                {campaign?.title}
              </h3>
            </Link>
            ...
            <div className="supporterCount mt-3 flex gap-2 items-center font-semibold text-gray-800">
              <FaHeart className="text-red-500 text-xl" /> {campaign?.supportersCount || 0 } Supporters
            </div>
