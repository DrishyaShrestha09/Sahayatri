    ...
    <div className="h-[calc(100vh-120px)] flex justify-center items-center">
      <div className="w-full max-w-sm mx-auto bg-[#F5F5F5] shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <form onSubmit={handleSubmit(onsubmit)}>
          <div className="mb-4">
            ...
            <input
              ...
              className="shadow appearance-none border border-gray-200 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow"
            />
          </div>
          <div className="mb-4">
            <label
        ...
        <p className="mt-5 text-center text-gray-500 text-sm">
          @2025 Sahayatri. All rights reserved
        </p>
      </div>
    </div>
  );
